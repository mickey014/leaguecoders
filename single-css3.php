    ...
    <div class="col-lg-2 col-sm-3">
      ...
      ?>
        ...
        <ul class="lesson-sidebar-container">
          ...
          <li>
            <h4 style="font-weight:bold;">CSS3 TUTORIAL</h4>
        ...
        <?php if ( have_posts() ) : ?>
          <?php while($query->have_posts()): $query->the_post(); ?>
            ...
            <li><a id="css3-sidebar" class="sidebar-link-lesson" href="<?= $home.the_permalink() ?>" style="<??>"><i class="fas fa-arrow-alt-circle-right" style="margin-right:.3rem"></i><?= the_title(); ?></a></li>
